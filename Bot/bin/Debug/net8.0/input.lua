...
local vb = {
  ...
  assert(bit.tobit(1) == 1, "ToBit")
  assert(bit.band(1) == 1, "BAnd")
  assert(bit.bxor(1,2) == 3, "BXor")
  assert(bit.bor(1,2,4,8,16,32,64,128) == 255, "BOr")
...
Replace standard Lua bytecode instructions with equivalent but less readable instructions.
lua
Copy code
-- Original Lua bytecode:
-- GETTABLE   0 0 -1    ; R0 = R0[-1]

-- Obfuscated bytecode:
-- SELF       0 0 -1 -1 ; R0 = R0[-1]
]]